...
Here is documentation about base implementation methods and properties. If you want to read about [`ViewModel`](/api/view-models/interface) methods and properties [go to here](/api/view-models/interface)  
...
### `vmConfig`  
This is view models configuration, you can read [here about it](/api/view-models/view-models-config)    
